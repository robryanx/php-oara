 ...
 * @category   Oara_Network_Tv
 * @copyright  Fubra Limited
 * @version    Release: 01.00
 * 
 */
class Oara_Network_Tv_Export extends Oara_Network_Base{
    /**
     * Export client.
	 ...
	 */
	public function __construct($terraVision, $groupId, $mode)
	{
		$configuration = $terraVision->AffiliateNetworkConfig->toArray();
		...
		$this->_client = new Oara_Curl_Access($loginUrl, $valuesLogin, $terraVision, $groupId, $mode);
	}
	/**
