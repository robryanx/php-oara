 ...
 *
 */
class Oara_Network_Omg_Export extends Oara_Network_Base{
    /**
	 ...
	 */
	public function __construct($omg, $groupId, $mode)
	{
		$configuration = $omg->AffiliateNetworkConfig->toArray();
		...
		$this->_client = new Oara_Curl_Access($loginUrl, $valuesLogin, $omg, $groupId, $mode);
