 ...
 *
 */
class Oara_Network_As_Export extends Oara_Network_Base{
	 ...
	 */
	public function __construct($as, $groupId, $mode)
	{
		$configuration = $as->AffiliateNetworkConfig->toArray();
		...
		// /adsense/
		$this->_client = new Oara_Curl_Access('https://www.google.com/adsense/', array(), $as, $groupId, $mode);
		...
		$valuesLogin[] = new Oara_Curl_Parameter('Passwd' , $passwordLogin);
