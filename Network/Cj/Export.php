 ...
 *
 */
class Oara_Network_Cj_Export extends Oara_Network_Base{
    /**
     ...
     */
    public function __construct($cj, $groupId, $mode)
    {
    	
        $configuration = $cj->AffiliateNetworkConfig->toArray();
        ...
        $this->_client = new Oara_Curl_Access($loginUrl, $valuesLogin, $cj, $groupId, $mode);
