 ...
 * 
 */
class Oara_Network_Tj_Export extends Oara_Network_Base{
    /**
     * Export client.
	 ...
	 */
	public function __construct($traveljigsaw, $groupId, $mode)
	{
		$configuration = $traveljigsaw->AffiliateNetworkConfig->toArray();
		...
		$this->_client = new Oara_Curl_Access($loginUrl, $valuesLogin, $traveljigsaw, $groupId, $mode);
