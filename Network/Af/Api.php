 ...
 *
 */
class Oara_Network_Af_Api extends Oara_Network_Base{
    /**
	 ...
	 */
	public function __construct($af, $groupId, $mode)
	{
		$configuration = $af->AffiliateNetworkConfig->toArray();
		...
		$this->_client = new Oara_Curl_Access($loginUrl, $valuesLogin, $af, $groupId, $mode);
