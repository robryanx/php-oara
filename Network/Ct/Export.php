 ...
 * 
 */
class Oara_Network_Ct_Export extends Oara_Network_Base{
    /**
     * Export client.
	 ...
	 */
	public function __construct($cartrawler, $groupId, $mode)
	{
		$configuration = $cartrawler->AffiliateNetworkConfig->toArray();
		...
		$this->_client = new Oara_Curl_Access($loginUrl, $valuesLogin, $cartrawler, $groupId, $mode);
