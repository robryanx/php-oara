...
class SoapMethods extends ApiMethods implements IMethods {
	 ...
	 * @return      object or string                    list of media slot objects or false
	 */
	public function createMediaSlot($name, $adspaceId, $applicationId, $status, $width = 0, $height = 0, $format = NULL, $createDate = NULL, $modifiedDate = NULL) {
		$method = ucfirst(__FUNCTION__);
	 ...
	 * @return     object or string            program result set or false
	 */
	public function getProgramApplications($adspaceId = NULL, $programId = NULL, $status = NULL, $page = 0, $items = 10) {
		$method = ucfirst(__FUNCTION__);
