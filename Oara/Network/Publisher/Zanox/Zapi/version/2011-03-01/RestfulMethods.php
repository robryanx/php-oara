...
class RestfulMethods extends ApiMethods implements IMethods {
	 ...
	 */
	public function searchProducts($query, $searchType = 'phrase', $region = NULL, $categoryId = NULL, $programId = array(), $hasImages = true, $minPrice = 0, $maxPrice = NULL, $adspaceId = NULL, $page = 0, $items = 10) {
	 ...
	 */
	public function searchIncentives($programId = NULL, $adspaceId = NULL, $incentiveType = NULL, $region = NULL, $page = 0, $items = 10) {
	 ...
	 * @return      object or string            list of incentives or false
	 */
	public function searchExclusiveIncentives($programId = NULL, $adspaceId = NULL, $incentiveType = NULL, $region = NULL, $page = 0, $items = 10) {
		$resource = array('incentives');
	 ...
	 */
	public function getAdmedia($programId = NULL, $region = NULL, $format = NULL, $partnerShip = NULL, $purpose = NULL, $admediumType = NULL, $categoryId = NULL, $adspaceId = NULL, $page = 0, $items = 10) {
	 ...
	 * @return      object or string            application item or false
	 */
	public function getApplications($name = NULL, $width = NULL, $height = NULL, $format = NULL, $role = NULL, $applicationType = NULL, $page = 0, $items = 0) {
	 ...
	 * @return      object or string            application item or false
	 */
	public function createApplication($name = NULL, $version = NULL, $adrank = 0, $tags = NULL, $status = 0, $mediaSlotCompatible = false, $inline = false, $integrationCode = NULL, $integrationNotes = NULL, $description = NULL, $terms = NULL, $connectRole = NULL, $connectId = NULL, $connectStatus = NULL, $connectUrl = NULL, $cancelUrl = NULL, $documentationUrl = NULL, $companyUrl = NULL, $developer = NULL, $pricingShare = 0, $pricingSetup = 0, $pricingMonthly = 0, $pricingCurrency = NULL, $pricingDescription = NULL, $startDate = NULL, $modifiedDate = NULL, $installableTo = NULL, $applicationType = NULL, $width = NULL, $height = NULL, $format = NULL, $technique = NULL, $logoUrl = NULL, $previewUrl = NULL) {
	 ...
	 * @return      object or string            application item or false
	 */
	public function updateApplication($applicationId, $name = NULL, $version = NULL, $adrank = 0, $tags = NULL, $status = 0, $mediaSlotCompatible = false, $inline = false, $integrationCode = NULL, $integrationNotes = NULL, $description = NULL, $terms = NULL, $connectRole = NULL, $connectId = NULL, $connectStatus = NULL, $connectUrl = NULL, $cancelUrl = NULL, $documentationUrl = NULL, $companyUrl = NULL, $developer = NULL, $pricingShare = 0, $pricingSetup = 0, $pricingMonthly = 0, $pricingCurrency = NULL, $pricingDescription = NULL, $startDate = NULL, $modifiedDate = NULL, $installableTo = NULL, $applicationType = NULL, $width = NULL, $height = NULL, $format = NULL, $technique = NULL, $logoUrl = NULL, $previewUrl = NULL) {
		$resource = array('applications', 'application');
	 ...
	 */
	public function getSettings($applicationId, $mediaslotId = NULL, $page = 0, $items = 0) {
	 ...
	 */
	public function createSetting($applicationId, $mediaslotId = NULL, $key, $value, $customValue, $type = NULL, $name = NULL, $description = NULL) {
		$resource = array('applications', 'settings', 'application', $applicationId);
	 ...
	 * @return      object or string                setting
	 */
	public function updateSetting($applicationId, $mediaslotId = NULL, $key, $value, $customValue, $type = NULL, $name = NULL, $description = NULL) {
		$resource = array('applications', 'settings', 'application', $applicationId);
	 ...
	 */
	public function getMediaSlots($adspaceId, $width = 0, $height = 0, $format = NULL, $page = 0, $items = 0) {
	 ...
	 * @return      object or string                    list of media slot objects or false
	 */
	public function createMediaSlot($name, $adspaceId, $adspaceName = NULL, $applicationId, $applicationName = NULL, $status = NULL, $width = 0, $height = 0, $format = NULL, $createDate = NULL, $modifiedDate = NULL) {
	 ...
	 * @return      object or string                    list of media slot objects or false
	 */
	public function updateMediaSlot($mediaslotId, $name, $adspaceId, $adspaceName = NULL, $applicationId, $applicationName = NULL, $status = NULL, $width = 0, $height = 0, $format = NULL, $createDate = NULL, $modifiedDate = NULL) {
		$resource = array('mediaslots', 'mediaslot');
	 ...
	 */
	public function searchPrograms($query = NULL, $startDate = NULL, $partnerShip = NULL, $hasProducts = false, $region = NULL, $categoryId = NULL, $page = 0, $items = 10) {
	 ...
	 */
	public function getProgramApplications($programId = NULL, $adspaceId = NULL, $status = NULL, $page = 0, $items = 10) {
	 ...
	 * @return     object or string            sales result set or false
	 */
	public function getSales($date, $dateType = NULL, $programId = NULL, $adspaceId = NULL, $reviewState = NULL, $page = 0, $items = 10) {
	 ...
	 * @return     object or string            sales result set or false
	 */
	public function getLeads($date, $dateType = NULL, $programId = NULL, $adspaceId = NULL, $reviewState = NULL, $page = 0, $items = 10) {
	 ...
	 */
	public function getReportBasic($fromDate, $toDate, $dateType = NULL, $currency = NULL, $programId = NULL, $admediumId = NULL, $admediumFormat = NULL, $adspaceId = NULL, $reviewState = NULL, $groupBy = NULL) {
	 ...
	 * @return     object or string            adspace item or false
	 */
	public function createAdspace($name, $language, $url, $contact, $description, $adspaceType, $scope, $visitors, $impressions, $keywords = NULL, $regions = array(), $categories = array(), $checkNumber) {
	 ...
	 * @return     object or string            adspace item or false
	 */
	public function updateAdspace($adspaceId, $name, $language, $url, $contact, $description, $adspaceType, $scope, $visitors, $impressions, $keywords = NULL, $regions = array(), $categories = array(), $checkNumber) {
		$resource = array('adspaces', 'adspace', $adspaceId);
	 ...
	 * @return     boolean                     true on success
	 */
	public function updateProfile($profileId, $loginName, $userName, $firstName = NULL, $lastName = NULL, $email = NULL, $country = NULL, $street1 = NULL, $street2 = NULL, $city = NULL, $zipcode = NULL, $company = NULL, $phone = NULL, $mobile = NULL, $fax = NULL, $isAdvertiser, $isSublogin) {
		$resource = array('profiles');
