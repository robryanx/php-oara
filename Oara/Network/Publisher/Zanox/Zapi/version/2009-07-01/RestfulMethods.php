...
class RestfulMethods extends ApiMethods implements IMethods {
	 ...
	 */
	public function getProducts($programId, $adspaceId = NULL, $modifiedDate = NULL, $page = 0, $items = 10) {
	 ...
	 */
	public function searchProducts($query, $searchType = 'phrase', $ip = NULL, $region = NULL, $categoryId = NULL, $programId = array(), $hasImages = true, $minPrice = 0, $maxPrice = NULL, $adspaceId = NULL, $page = 0, $items = 10) {
	 ...
	 */
	public function searchPrograms($query, $startDate = NULL, $partnerShip = NULL, $hasProducts = false, $ip = NULL, $region = NULL, $categoryId = NULL, $page = 0, $items = 10) {
	 ...
	 */
	public function getAdmedia($programId = NULL, $ip = NULL, $region = NULL, $format = NULL, $partnerShip = NULL, $purpose = NULL, $admediumType = NULL, $categoryId = NULL, $adspaceId = NULL, $page = 0, $items = 10) {
	 ...
	 * @return     object or string            adspace item or false
	 */
	public function createAdspace($name, $lang, $url, $contact, $description, $adspaceType, $scope, $visitors, $impressions, $keywords = NULL, $regions = array(), $categories = array()) {
	 ...
	 * @return     object or string            adspace item or false
	 */
	public function updateAdspace($adspaceId, $name, $lang, $url, $contact, $description, $adspaceType, $scope, $visitors, $impressions, $keywords = NULL, $regions = array(), $categories = array()) {
		$resource = array('adspaces', 'adspace', $adspaceId);
	 ...
	 * @return     boolean                     true on success
	 */
	public function updateProfile($profileId, $firstName, $lastName, $email, $country, $street1, $street2 = NULL, $city, $zipcode, $company = NULL, $phone = NULL, $mobile = NULL, $fax = NULL) {
		$resource = array('profiles');
