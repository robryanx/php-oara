 ...
 * @category   Oara_Network_Publisher_AirportHotelShop
 * @copyright  Fubra Limited
 * @version    Release: 01.00
 *
 */
class Oara_Network_Publisher_AirportHotelShop extends Oara_Network {
	...
	public $_merchantMap = array( "SB"=> 1, "HE" => 2, "FHR" =>3, "APH" =>4 );
	/**
	 * Constructor.
	 * @param $credentials
