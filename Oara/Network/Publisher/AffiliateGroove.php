 ...
 *
 */
class Oara_Network_Publisher_AffiliateGroove extends Oara_Network {
	...
	private function logIn() {
		...
		$options[CURLOPT_URL] = 'http://affiliategroove.com/affiliates/login.php#login';
		...
		$loginUrl = 'http://affiliategroove.com/scripts/server.php';
	...
	public function getTransactionList($merchantList = null, Zend_Date $dStartDate = null, Zend_Date $dEndDate = null, $merchantMap = null) {
		...
		if ($this->_transactionList == null) {
			$urls = array ();
			$valuesExport = array (
					new Oara_Curl_Parameter ( 'filters', '[]' ),
					new Oara_Curl_Parameter ( 'sort_col', 'dateinserted' ),
					new Oara_Curl_Parameter ( 'columns', '[["id"],["id"],["commission"],["totalcost"],["fixedcost"],["t_orderid"],["productid"],["dateinserted"],["name"],["rtype"],["tier"],["commissionTypeName"],["rstatus"],["merchantnote"],["channel"]]' ),
					new Oara_Curl_Parameter ( 'sort_asc', 'false' ),
					new Oara_Curl_Parameter ( 'csv_export_timezone', 'S' ),
					new Oara_Curl_Parameter ( 'delimiter', 'c' ),
			);
			$urls [] = new Oara_Curl_Request ( 'https://affiliategroove.com/scripts/server.php?C=Pap_Affiliates_Reports_TransactionsGrid&M=getCSVFile&S='. $this->_s . '&FormRequest=Y&FormResponse=Y', $valuesExport );
			$exportReport = array ();
