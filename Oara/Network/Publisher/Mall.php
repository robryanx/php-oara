 ...
 *
 */
class Mall extends \Oara\Network
{
    /**
     * Export client.
    ...
    public function login($credentials)
    {
        ...
        $this->_exportTransactionParameters = array(new \Oara\Curl\Parameter('reportName', 'aAffiliateEventBreakdownReport'),
            ...
            new \Oara\Curl\Parameter('separator', ','),
            new \Oara\Curl\Parameter('format', 'CSV'),
            new \Oara\Curl\Parameter('currencyId', 'GBP')
        );
                            ...
                            if ($this->_dateFormat == 'jj/MM/aa') {
                                ...
                                if ($this->_dateFormat == 'dd.MM.yy') {
                                    ...
                                    if ($this->_dateFormat == 'yy-MM-dd') {
                                        $dateString = $date->format!('yy-MM-dd');
                                    } else
                                        if ($this->_dateFormat == 'd-M-yy') {
                                            $dateString = $date->format!('d-M-yy');
                                        } else {
                        ...
                        if ($this->_dateFormat == 'jj-MM-aa') {
                            ...
                            if ($this->_dateFormat == 'jj/MM/aa') {
                                ...
                                if ($this->_dateFormat == 'dd.MM.yy') {
                                    ...
                                    if ($this->_dateFormat == 'yy-MM-dd') {
                                        $transactionDate = new \DateTime(trim($dateString), "yy-MM-dd HH:mm:ss");
                                    } else
                                        if ($this->_dateFormat == 'd-M-yy') {
