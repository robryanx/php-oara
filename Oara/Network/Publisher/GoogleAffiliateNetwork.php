...
require_once "GoogleApiClient/src/contrib/apiGanService.php";
/**
 * API Class
 *
 * @author     Carlos Morillo Merino
 * @category   Oara_Network_Publisher_GoogleAffiliateNetwork
 * @copyright  Fubra Limited
 * @version    Release: 01.00
 *
 */
class Oara_Network_Publisher_GoogleAffiliateNetwork extends Oara_Network {
	...
	public function checkConnection() {
		...
		if ($this->_client->getAccessToken()) {
			$advertiser = $this->_gan->publishers->get("publishers");
