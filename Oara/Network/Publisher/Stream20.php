 ...
 *
 */
class Stream20 extends \Oara\Network
{
    /**
     * Export client.
        ...
        for ($i = 2; $i < $num - 1; $i++) {
            ...
            if ($transactionExportArray[0] !== '') {
                ...
                if ($transactionExportArray[18] != '') {
                    $transaction['amount'] = \Oara\Utilities::parseDouble($transactionExportArray[18]);
                } else {
                    $transaction['amount'] = \Oara\Utilities::parseDouble($transactionExportArray[19]);
                }

                $transaction['commission'] = \Oara\Utilities::parseDouble($transactionExportArray[19]);
